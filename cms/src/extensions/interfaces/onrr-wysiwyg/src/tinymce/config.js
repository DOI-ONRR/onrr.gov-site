export function createTinyConfig() {
  const base = {
    ...
    toolbar: 'bold italic underline blocks forecolor | alignleft aligncenter alignright | onrr-table numlist bullist hr removeformat blockquote onrr-glossary onrr-link image code',
    plugins: 'lists image code onrr-link onrr-table table onrr-glossary',
    external_plugins: {
      "onrr-link": '/wysiwyg-static/plugins/link.js',
      "onrr-table": '/wysiwyg-static/plugins/table.js',
      "onrr-glossary": '/wysiwyg-static/plugins/glossary.js'
    },
